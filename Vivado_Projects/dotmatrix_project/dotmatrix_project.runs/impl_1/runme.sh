...
HD_PWD='C:/Users/desig/Documents/GitHub/FPGA_Projects/Vivado_Projects/dotmatrix_project/dotmatrix_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_top_module.tcl -notrace
