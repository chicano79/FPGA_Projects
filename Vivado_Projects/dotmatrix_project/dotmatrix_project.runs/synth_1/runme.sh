...
HD_PWD='C:/Users/desig/Documents/GitHub/FPGA_Projects/Vivado_Projects/dotmatrix_project/dotmatrix_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_top_module.tcl
