...
HD_PWD='C:/Users/Jonas/Documents/rt_clock/vivado_proj/rt_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_arty_s7_50.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_arty_s7_50.tcl -notrace
