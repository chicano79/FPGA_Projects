...
HD_PWD='C:/Users/desig/Documents/GitHub/FPGA_Projects/Vivado_Projects/I2C_controller/RTCC/RTCC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RTCC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RTCC.tcl -notrace
