...
HD_PWD='C:/Users/desig/Documents/GitHub/FPGA_Projects/Vivado_Projects/I2C_controller/RTCC/RTCC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RTCC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RTCC.tcl
