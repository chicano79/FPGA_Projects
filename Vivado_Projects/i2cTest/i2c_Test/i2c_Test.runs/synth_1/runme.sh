...
HD_PWD='C:/Users/desig/Documents/GitHub/FPGA_Projects/Vivado_Projects/i2cTest/i2c_Test/i2c_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2cTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2cTest.tcl
