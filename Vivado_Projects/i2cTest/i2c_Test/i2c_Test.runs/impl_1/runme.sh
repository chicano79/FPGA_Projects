...
HD_PWD='C:/Users/desig/Documents/GitHub/FPGA_Projects/Vivado_Projects/i2cTest/i2c_Test/i2c_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2cTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2cTest.tcl -notrace
