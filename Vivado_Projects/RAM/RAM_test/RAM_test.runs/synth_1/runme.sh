...
HD_PWD='C:/Users/desig/Documents/FPGA/FPGA_Projects/Vivado_Projects/RAM/RAM_test/RAM_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_tb.tcl
