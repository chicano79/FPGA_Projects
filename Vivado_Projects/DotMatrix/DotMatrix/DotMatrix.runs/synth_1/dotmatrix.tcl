...
synth_design -top dotmatrix -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef dotmatrix.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file dotmatrix_utilization_synth.rpt -pb dotmatrix_utilization_synth.pb"
